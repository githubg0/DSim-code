...
parser.add_argument('--run_dir',        type=str,   default='run/result/', help='dir to save log and models')
# parser.add_argument('--data_dir',       type=str,   default='data/debug_samples/') 
parser.add_argument('--data_dir',       type=str,   default='data/ednet500/') 
...
parser.add_argument('--batch_size',     type=int,   default=24,      help='number of instances in a batch')
...
parser.add_argument('--alpha_emb',  type=float,   default=0.1,   help='the value of alpha') 
parser.add_argument('--alpha_bce',  type=float,   default=5.0,   help='the value of alpha') 
parser.add_argument('--alpha_state',  type=float,   default=1.0,   help='the value of alpha') 
parser.add_argument('--alpha_diff',  type=float,   default=5.0,   help='the value of alpha')
...
parser.add_argument('--predict_num',  type=int,   default=6,  help='the number augmented question, (predict_num + 1) % 4 == 0 is required')
